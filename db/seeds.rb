...
casper = User.create(full_name: 'Casper Ghost')

puts "generating hauted houses"
Property.create(name: "Bates Motel", address: "old highway 10" ,price: 200, haunted_level: 5, user_id: casper.id)
Property.create(name: "Ghost Cottage", address: "old highway 10" ,price: 200, haunted_level: 4, user_id: casper.id)
